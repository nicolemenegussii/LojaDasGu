    ...
    ALTER TABLE produto
    ADD COLUMN url_foto_produto VARCHAR(255);

   -- ALTER TABLE cliente
   -- MODIFY COLUMN senha_cliente VARCHAR(255) NOT NULL;

   -- DROP  IF EXISTS ;

   -- Atualizar vários produtos
    UPDATE produto 
    SET url_foto_produto = 'https://m.media-amazon.com/images/I/71jYmmRJPmL.jpg'
    WHERE id_produto = 8;
    ...
    -- senha tem que ser criptografada, se não perdemos nota

    -- Lista todos admins atuais
